...
else
{
  ...
  if(isset($_POST['add']))
  {
    ...
    $uploaded_by = isset($_SESSION['alogin'])?$_SESSION['alogin']:'';
    ...
    $sql="INSERT INTO  tblbooks(BookName,CatId,AuthorId,ISBNNumber,BookPrice,uploaded_by,uploaded_type,book_image,book_description)
    VALUES
    (:bookname,:category,:author,:isbn,:price,:uploaded_by,:uploaded_type,:book_image,:des)";
    ...
    $query->bindParam(':des',$desc, PDO::PARAM_STR);
