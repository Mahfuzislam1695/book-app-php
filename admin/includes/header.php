                    ...
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                           ...
                           <li>
                            ...
                            <li>
                                 <a href="#" class="dropdown-toggle" id="ddlmenuItem1" data-toggle="dropdown"> Tags <i class="fa fa-angle-down"></i></a>
                                 <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem1">
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="add-tag.php">Add new</a></li>
