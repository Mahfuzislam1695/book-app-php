...
<head>
    ...
    <!--[if IE]>
        ...
        <![endif]-->
    <title>Online Book Sharing System | Admin Dash Board</title>
...
<!-- MENU SECTION END-->
 ...
 <div class="col-md-3 col-sm-3 col-xs-6">
                 ...
                 <div class="col-md-3 col-sm-3 col-xs-6">
                     <a href="manage-issued-books.php" style="text-decoration:none;"> 
...
?>
               ...
               <div class="col-md-3 col-sm-3 col-xs-6">
                     <a href="reg-students.php" style="text-decoration:none;"> 
