...
{
  global $dbh;
  $sql = "SELECT reply.id, reply.fromEmail, reply.toEmail, reply.name, reply.phone, reply.message, reply.added_at from reply where reply.message_id = :id ORDER by reply.added_at DESC";
